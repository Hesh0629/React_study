...
var btnDecrease = document.querySelector('#decrease'); // 액션 이름은 문자열로 만들어야함

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // 그 이후, 액션 객체를 만드는 생성 함수 제작
...
render(); // 상태가 업데이트될 때 마다 render함수 실행

store.subscribe(render); // 짜잔 onClick이 아니라 onclick 이랍니다.
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "44546" + '/');
